...
local function showObstacles()
  ...
  obs2 = display.newRect( target.x-target.width, centerY, obstacleHeight, obstacleWidth*1.2 )
  obs2:setFillColor(0.5)
  obs2.rotation = 20
  
  obs3 = display.newRect( target.x+target.width, centerY, obstacleHeight, obstacleWidth*1.2 )
