...
local function showObstacles()
  ...
  obs2 = display.newRect( target.x-target.width, obs1.y, obstacleHeight, obstacleWidth*1.2 )
  obs2:setFillColor(0.5)
  obs2.rotation = 20
  
  obs3 = display.newRect( target.x+target.width, obs1.y, obstacleHeight, obstacleWidth*1.2 )
  obs3:setFillColor(0.5)
  obs3.rotation = 20

  physics.addBody( obs1, "dynamic", {density=1, friction=frictionValue} )
